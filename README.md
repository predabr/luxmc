<div align="center">
  ...
  <h1>Luxmc Launcher <span style="color:#e2b86b">v0.6 BETA</span></h1>
...
- 🎨 **Visual 3D:** Cutscene em tempo real com áudio e partículas, visualizador volumétrico de skins e design premium de vidro fosco.
...
```bash
chmod +x luxmc-0.6.0-beta.AppImage
./luxmc-0.6.0-beta.AppImage
```

### 🔴 Debian-based (Ubuntu, Pop!_OS, Mint)
```bash
sudo apt install ./luxmc_0.6.0_amd64.deb
```

### 🔵 RedHat-based (Fedora, openSUSE)
```bash
sudo dnf install ./luxmc-0.6.0.x86_64.rpm
```
