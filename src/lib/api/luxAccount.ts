...
const preferencesSchema = z.object({
    ...
    language: z.enum(["pt-BR", "en"]).nullish(),
...
export type CloudPreferences = { theme?: "default-dark" | "default-light"; accentTheme?: "gold" | "cyan" | "emerald" | "rose" | "violet" | "orange" | "blue"; language?: "pt-BR" | "en"; animations?: boolean };
