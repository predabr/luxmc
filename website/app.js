...
const directDownloadUrls = {
  linux: "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.7_amd64.AppImage",
  windows: "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.7_x64-setup.exe",
  deb: "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.7_amd64.deb"
};
...
function initOSDetection() {
  ...
  if (isWindows) {
    ...
    if (btnLabel) {
      ...
      if (btn) btn.href = "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.7_x64-setup.exe";
    } else if (btn) {
    ...
    if (btnLabel) {
      ...
      if (btn) btn.href = "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.7_amd64.AppImage";
    } else if (btn) {
