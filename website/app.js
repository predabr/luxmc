...
function initOSDetection() {
  ...
  if (isWindows) {
    ...
    if (btnLabel) {
      ...
      if (btn) btn.href = "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.6_x64-setup.exe";
    } else if (btn) {
    ...
    if (btnLabel) {
      ...
      if (btn) btn.href = "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.7.6_amd64.AppImage";
    } else if (btn) {
