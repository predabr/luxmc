...
const directDownloadUrls = {
  linux: "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.9.1_amd64.AppImage",
  windows: "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.9.1_x64-setup.exe",
  deb: "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.9.1_amd64.deb"
};
...
function initOSDetection() {
  ...
  if (isWindows) {
    ...
    if (btnLabel) {
      ...
      if (btn) btn.href = "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.9.1_x64-setup.exe";
    } else if (btn) {
    ...
    if (btnLabel) {
      ...
      if (btn) btn.href = "https://github.com/predabr/luxmc/releases/latest/download/Luxmc_1.9.1_amd64.AppImage";
    } else if (btn) {
...
function initBenchmarkVisualizer() {
  ...
  const data = {
    fps: [
      { name: "Luxmc v1.9.1", val: "285 FPS", percent: 100, highlight: true, badge: "Vulkan Zink" },
    ...
    ram: [
      { name: "Luxmc v1.9.1", val: "< 82 MB", percent: 12, highlight: true, badge: "Rust Nativo" },
    ...
    boot: [
      { name: "Luxmc v1.9.1", val: "0.38s", percent: 5, highlight: true, badge: "Instantâneo" },
